        ...
        <h3 class="pb-3" >
            ...
            <div id="p1" class="col-md-7">
              <div class="card border-0 flex-md-row box-shadow h-md-250">
                <div class="card-body d-flex flex-column align-items-start">
                  <h5 class="d-inline-block mb-2" v-text="p1.title">{{p1.title}}</h5>
                  <h6 class="mb-5">
            ...
            <div class="col-md-5 pl-0">
              <div class="card border-0 flex-md-row box-shadow h-md-250">
                <div class="card-body d-flex flex-column align-items-start">
                  ...
                  <span class="text-primary">¥{{p2.price}}</span>
          ...
          <div class="row mb-2">
            <div class="col-md-5">
              <div class="card border-0 flex-md-row box-shadow h-md-250">
                <div class="card-body d-flex flex-column align-items-start">
                  <h5 class="d-inline-block mb-3" v-text="p3.details"></h5>
            ...
            <div class="col-md-7 pl-0 ">
              <div id="others" class="row pr-3 "  >
                <div class="col-md-4 p-0 pl-2 " v-for="(item,i) of others" :key="i">
                  <div class="card border-0 text-center">
                    <img class="card-img-top" :src="others[i].pic"  alt="Card image cap">
                    <div class="card-body p-0 pr-1 pl-1">
                      <span class="d-inline-block" v-text="others[i].details"></span>
                      <span class="text-primary small">¥{{others[i].price}}</span>
                      <router-link class="btn btn-sm btn-primary" :to="`/details/${others[i].href.split('=')[1]}`">查看详情</router-link>
                    </div>
                  </div>
                </div>
                <!--删除后两个片段-->
